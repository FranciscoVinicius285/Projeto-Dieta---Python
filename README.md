...
Este projeto foi desenvolvido a partir da disciplina “Desenvolvimento Rápido de Aplicações em Python”, utilizando a linguagem Python com CRUD, o banco de dados SQLite e o framework Tkinter para a interface gráfica. O trabalho foi conduzido com base na metodologia RAD (Rapid Application Development), partindo da criação de um protótipo funcional.
